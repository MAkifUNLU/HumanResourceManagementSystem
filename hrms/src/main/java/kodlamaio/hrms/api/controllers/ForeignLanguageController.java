...
public class ForeignLanguageController {
	...
	@Autowired
	public ForeignLanguageController(CVForeignLanguageService cVForeignLanguageService) {
		super();
		this.cVForeignLanguageService = cVForeignLanguageService;
	}

	@PostMapping("/add")
	public Result add(@RequestBody CVForeignLanguage foreignLanguageForCV){
		return this.cVForeignLanguageService.add(foreignLanguageForCV);
	}
